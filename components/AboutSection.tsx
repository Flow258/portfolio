...
export default function AboutSection() {
  ...
  const interests = [
    { name: 'Digital Art', icon: Palette, color: 'from-pink-500 to-rose-500' },
    { name: 'Problem Solving', icon: Lightbulb, color: 'from-yellow-500 to-orange-500' },
    { name: 'Creative Coding', icon: Code, color: 'from-purple-500 to-blue-500' },
    { name: 'UI/UX Design', icon: Target, color: 'from-cyan-500 to-teal-500' },
    { name: 'Learning', icon: Heart, color: 'from-red-500 to-pink-500' },
    { name: 'Coffee', icon: Coffee, color: 'from-amber-500 to-yellow-500' }
  ]

  const stats = [
    { label: 'Years Learning', value: '3+', icon: Calendar },
    { label: 'Projects Built', value: '9', icon: Code },
    //{ label: 'Technologies', value: '10+', icon: Target },
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-purple-400/5 to-blue-400/5 rounded-full blur-2xl animate-float" />
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-to-br from-cyan-400/5 to-pink-400/5 rounded-full blur-2xl animate-float" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6">
            About <span className="bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 bg-clip-text text-transparent">Me</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className={`space-y-8 transition-all duration-1000 delay-300 ${
            ...
            {/* Tab navigation */}
            <div className="flex flex-wrap gap-2 bg-gray-100/80 p-2 rounded-2xl backdrop-blur-sm">
              {tabs.map((tab) => {
            ...
            {/* Tab content */}
            <Card className="border border-gray-200/50 shadow-lg bg-white/80 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {stats.map((stat, index) => {
                ...
                return (
                  <Card 
                    key={index}
                    className="text-center p-4 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-white/80 backdrop-blur-sm border border-gray-200/50"
                  >
          ...
          <div className={`space-y-8 transition-all duration-1000 delay-500 ${
            ...
            <Card className="overflow-hidden border-0 shadow-2xl group">
              <CardContent className="p-0 relative">
                <div className="relative">
                  ...
                  <div className="aspect-square bg-gradient-to-br from-purple-400 via-blue-500 to-cyan-400 flex items-center justify-center overflow-hidden group-hover:scale-105 transition-transform duration-700">
                    ...
                    />
                    {/* Fallback */}
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-white" style={{ display: 'none' }}>
            ...
            <Card className="bg-gradient-to-br from-gray-50 to-purple-50/50 border border-gray-200/50 shadow-lg">
              <CardContent className="p-8">
                  ...
                  {interests.map((interest, index) => {
                    ...
                    return (
                      ...
                      >
                        <Badge 
                          variant="secondary" 
                          className={`w-full justify-center py-3 px-4 text-sm font-medium bg-gradient-to-r ${interest.color} text-white hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-default border-0`}
                        >
                ...
                {/* Fun fact */}
                <div className="mt-8 p-4 bg-white/80 rounded-xl border border-gray-200/50">
            ...
            {/* Timeline highlight */}
            <Card className="bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200/50 shadow-lg">
              <CardContent className="p-8">
                <h4 className="text-xl font-bold text-gray-800 mb-6">Quick Timeline</h4>
                
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    <div className="w-3 h-3 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full"></div>
                    <div>
                      <div className="font-semibold text-gray-800">2023 - Started Coding</div>
                      <div className="text-sm text-gray-600">Began learning Python & web development</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="font-semibold text-gray-800">2024 - Full Stack</div>
                      <div className="text-sm text-gray-600">Learn Java, React, Node.js & databases</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="font-semibold text-gray-800">2025 - Growing</div>
                      <div className="text-sm text-gray-600">Building projects & learning daily</div>
                    </div>
                  </div>
                </div>
              </CardContent>
